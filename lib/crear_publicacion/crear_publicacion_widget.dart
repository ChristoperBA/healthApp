...
import 'crear_publicacion_model.dart';
export 'crear_publicacion_model.dart';
...
class _CrearPublicacionWidgetState extends State<CrearPublicacionWidget> {
  late CrearPublicacionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearPublicacionModel());
