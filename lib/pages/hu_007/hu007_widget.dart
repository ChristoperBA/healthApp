...
import 'hu007_model.dart';
export 'hu007_model.dart';

class Hu007Widget extends StatefulWidget {
  const Hu007Widget({super.key});

  @override
  State<Hu007Widget> createState() => _Hu007WidgetState();
}

class _Hu007WidgetState extends State<Hu007Widget> {
  late Hu007Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu007Model());
  }
