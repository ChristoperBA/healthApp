...
import 'hu008_model.dart';
export 'hu008_model.dart';

class Hu008Widget extends StatefulWidget {
  const Hu008Widget({super.key});

  @override
  State<Hu008Widget> createState() => _Hu008WidgetState();
}

class _Hu008WidgetState extends State<Hu008Widget> {
  late Hu008Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu008Model());
  }
