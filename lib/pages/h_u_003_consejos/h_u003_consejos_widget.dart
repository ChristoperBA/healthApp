...
import 'h_u003_consejos_model.dart';
export 'h_u003_consejos_model.dart';

class HU003ConsejosWidget extends StatefulWidget {
  const HU003ConsejosWidget({super.key});

  @override
  State<HU003ConsejosWidget> createState() => _HU003ConsejosWidgetState();
}

class _HU003ConsejosWidgetState extends State<HU003ConsejosWidget> {
  late HU003ConsejosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HU003ConsejosModel());
  }
