      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            title: Padding(
              padding: EdgeInsetsDirectional.fromSTEB(70.0, 20.0, 0.0, 0.0),
              child: Text(
                'Menú',
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 5.0),
                                child:
                                    StreamBuilder<List<ActividadFisicaRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<ActividadFisicaRecord>
                                        buttonActividadFisicaRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final buttonActividadFisicaRecord =
                                        buttonActividadFisicaRecordList
                                                .isNotEmpty
                                            ? buttonActividadFisicaRecordList
                                                .first
                                    ...
                                    return FFButtonWidget(
                                      ...
                                      text: buttonActividadFisicaRecord!
                                          .caloriasGastadas
                                          .toString(),
                                      icon: FaIcon(
                                ...
                                child:
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    return FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed(
                                            'HU_002_ActividadDiaria');
                                      },
                                      text: buttonActividadFisicaRecord!.pasos
                                          .toString(),
                                      icon: FaIcon(
                            ...
                            children: [
                              StreamBuilder<List<ActividadFisicaRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final buttonActividadFisicaRecord =
                                      buttonActividadFisicaRecordList.isNotEmpty
                                          ? buttonActividadFisicaRecordList
                                              .first
                                          : null;
                                  return FFButtonWidget(
                                    onPressed: () async {
                                      context
                                          .pushNamed('HU_002_ActividadDiaria');
                                    },
                                    text: buttonActividadFisicaRecord!.distancia
                                        .toString(),
                                    icon: Icon(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed('HU_005_Medicamentos');
                                  },
                                  text: 'Ingresar',
                                  options: FFButtonOptions(
                                    width: MediaQuery.sizeOf(context).width *
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        context.pushNamed('HU_003_Consejos');
                                      },
                                      text: 'Ingresar',
                                      options: FFButtonOptions(
                                        width:
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('HU_010_Salud');
                                    },
                                    text: 'Ingresar',
                                    options: FFButtonOptions(
                                      width: MediaQuery.sizeOf(context).width *
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('HU_009_Noticias');
                                    },
                                    text: 'Ingresar',
                                    options: FFButtonOptions(
                                      width: MediaQuery.sizeOf(context).width *
