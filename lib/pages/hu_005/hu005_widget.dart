...
import 'hu005_model.dart';
export 'hu005_model.dart';

class Hu005Widget extends StatefulWidget {
  const Hu005Widget({super.key});

  @override
  State<Hu005Widget> createState() => _Hu005WidgetState();
}

class _Hu005WidgetState extends State<Hu005Widget> {
  late Hu005Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu005Model());
  }
