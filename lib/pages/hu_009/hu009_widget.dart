...
import 'hu009_model.dart';
export 'hu009_model.dart';

class Hu009Widget extends StatefulWidget {
  const Hu009Widget({super.key});

  @override
  State<Hu009Widget> createState() => _Hu009WidgetState();
}

class _Hu009WidgetState extends State<Hu009Widget> {
  late Hu009Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu009Model());
  }
