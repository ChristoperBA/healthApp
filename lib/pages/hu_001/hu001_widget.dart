...
import 'hu001_model.dart';
export 'hu001_model.dart';

class Hu001Widget extends StatefulWidget {
  const Hu001Widget({super.key});

  @override
  State<Hu001Widget> createState() => _Hu001WidgetState();
}

class _Hu001WidgetState extends State<Hu001Widget> {
  late Hu001Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu001Model());
  }
