...
import 'hu003_model.dart';
export 'hu003_model.dart';

class Hu003Widget extends StatefulWidget {
  const Hu003Widget({super.key});

  @override
  State<Hu003Widget> createState() => _Hu003WidgetState();
}

class _Hu003WidgetState extends State<Hu003Widget> {
  late Hu003Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu003Model());
  }
