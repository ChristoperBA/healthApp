...
import 'hu002_model.dart';
export 'hu002_model.dart';

class Hu002Widget extends StatefulWidget {
  const Hu002Widget({super.key});

  @override
  State<Hu002Widget> createState() => _Hu002WidgetState();
}

class _Hu002WidgetState extends State<Hu002Widget> {
  late Hu002Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu002Model());
  }
