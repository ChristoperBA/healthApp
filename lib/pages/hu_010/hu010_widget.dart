...
import 'hu010_model.dart';
export 'hu010_model.dart';

class Hu010Widget extends StatefulWidget {
  const Hu010Widget({super.key});

  @override
  State<Hu010Widget> createState() => _Hu010WidgetState();
}

class _Hu010WidgetState extends State<Hu010Widget> {
  late Hu010Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Hu010Model());
  }
